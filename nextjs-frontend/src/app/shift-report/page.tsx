      ...
      <div className="space-y-6 print:space-y-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
          <div>
            ...
            <p className="text-gray-500 mt-1">Generate and export shift summary reports</p>
          </div>
        ...
        {/* Report Header */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 text-white print:bg-gray-100 print:text-gray-900">
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2 mb-2 print:mb-1">
                <FileText className="w-6 h-6 print:w-5 print:h-5" />
                <span className="text-blue-100 print:text-gray-600">Shift Report</span>
              </div>
            ...
            <div className="text-right">
              <p className="text-blue-100 print:text-gray-600 text-sm">Report Date</p>
              <p className="text-xl font-bold print:text-lg">{new Date(selectedDate).toLocaleDateString()}</p>
              <p className="text-blue-100 print:text-gray-600 text-sm mt-2">Generated by</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 print:grid-cols-5 print:gap-2">
          <div className="bg-blue-50 rounded-xl p-4 text-center print:p-2">
            ...
            <p className="text-2xl font-bold text-gray-900 print:text-lg">{stats.expected_workers}</p>
          ...
          <div className="bg-green-50 rounded-xl p-4 text-center print:p-2">
            ...
            <p className="text-2xl font-bold text-gray-900 print:text-lg">{stats.workers_entered}</p>
          ...
          <div className="bg-purple-50 rounded-xl p-4 text-center print:p-2">
            ...
            <p className="text-2xl font-bold text-gray-900 print:text-lg">{stats.workers_exited}</p>
          ...
          <div className="bg-red-50 rounded-xl p-4 text-center print:p-2">
            ...
            <p className="text-2xl font-bold text-gray-900 print:text-lg">{stats.violations_this_shift}</p>
          ...
          <div className="bg-cyan-50 rounded-xl p-4 text-center print:p-2">
            ...
            <p className="text-2xl font-bold text-gray-900 print:text-lg">{stats.compliance_rate}%</p>
        ...
        <Card title="PPE Compliance Summary">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-4">Compliance Breakdown</h4>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-sm text-gray-600">Compliant Workers</span>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-sm text-gray-600">Non-Compliant Workers</span>
            ...
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-4">Entry Status</h4>
